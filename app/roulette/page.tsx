...
export const metadata: Metadata = {
  ...
  description:
    '에볼루션카지노 룰렛 규칙·전략·베팅 방법 완벽 정리. 라이트닝 룰렛, 이머시브 룰렛, 유럽식·미국식 룰렛까지 변형 게임 총망라. 초보자도 쉽게 이해하는 가이드.',
  keywords: ['에볼루션카지노 룰렛', '에볼루션 룰렛', '라이트닝 룰렛', '룰렛 전략', '룰렛 규칙'],
  alternates: { canonical: 'https://wooriwin.com/roulette' },
  openGraph: {
    title: '에볼루션카지노 룰렛 완벽 가이드 2026 | WOORIWIN',
    description:
      '에볼루션 룰렛 규칙·전략·변형 게임 완벽 정리. 라이트닝 룰렛 500배부터 프렌치 룰렛 앙 프리종까지 총망라.',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '유럽식 룰렛(싱글 제로)의 RTP는 97.30%, 아메리칸 룰렛(더블 제로)은 94.74%입니다. 라이트닝 룰렛은 기본 RTP 97.30%에 멀티플라이어가 적용되는 구조로, 일반 룰렛보다 변동성이 큽니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '라이트닝 룰렛은 매 스핀마다 1~5개의 번호에 50x·100x·200x·300x·500x 멀티플라이어가 무작위로 적용됩니다. 해당 번호에 스트레이트업 베팅이 맞으면 멀티플라이어 배당을 받습니다. 단, 멀티플라이어가 없는 번호의 스트레이트업 당첨은 29:1로 일반 룰렛(35:1)보다 낮습니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '유럽식 룰렛은 0~36번 총 37개 칸(싱글 제로), 아메리칸 룰렛은 0·00·1~36 총 38개 칸(더블 제로)입니다. 더블 제로 때문에 아메리칸 룰렛의 하우스 엣지는 5.26%로 유럽식(2.70%)의 두 배입니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '이머시브 룰렛(Immersive Roulette)은 HD 멀티캠 카메라로 볼이 떨어지는 순간을 슬로우 모션으로 보여주는 시각적 몰입감에 특화된 룰렛입니다. 규칙과 RTP는 유럽식 룰렛과 동일합니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '앙 프리종 룰은 이븐머니 베팅 시 볼이 0에 떨어지면 베팅이 몰수되지 않고 다음 스핀에 유지되는 규칙입니다. 덕분에 프렌치 룰렛의 이븐머니 베팅 RTP는 98.65%로 매우 높습니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '더블볼 룰렛은 한 스핀에 두 개의 볼을 동시에 사용하는 에볼루션 독점 변형 게임입니다. 두 볼 모두 같은 번호에 떨어지면 스트레이트업 베팅이 1,300:1 배당을 받습니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '에볼루션 룰렛의 최소 베팅은 테이블에 따라 $0.10~$1 수준입니다. 라이트닝 룰렛은 최소 $0.20부터 시작합니다.',
      },
    },
  ] satisfies FAQItem[],
}
...
export default function RoulettePage() {
  ...
  const relatedPosts = getRelatedBlogPosts(['룰렛 & 포커'], 3)
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-900 text-white">
        ...
        <section className="relative flex flex-col items-center justify-center min-h-[55vh] text-center px-4 py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <nav aria-label="breadcrumb" className="text-sm text-gray-400 mb-6">
              ...
              {' '}&rsaquo;{' '}
              <span className="text-white" aria-current="page">룰렛</span>
            </nav>
        ...
        <section className="max-w-4xl mx-auto px-4 py-20 text-gray-300">
          ...
          <header className="mb-16 border-b border-gray-800 pb-8">
            <div className="flex items-center space-x-3 mb-4">
              <span className="bg-yellow-400 text-black px-3 py-1 rounded-full text-sm font-bold uppercase tracking-wider">Roulette Strategy</span>
            </div>
            {/* E-E-A-T: 저자 */}
        ...
        {relatedPosts.length > 0 && (
          <section className="bg-gray-800 py-16 px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-3">에볼루션카지노 룰렛 관련 글</h2>
