    ...
    <main className="min-h-screen text-white" style={{ background: '#0A0A0F' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-14">
        ...
        <div className="rounded-xl p-6" style={{ background: 'rgba(120,20,20,0.25)', border: '1px solid rgba(180,30,30,0.4)' }}>
          <p className="font-bold text-red-400 mb-3 flex items-center gap-2">⚠️ 중요 안내</p>
          <ul className="text-sm space-y-2" style={{ color: '#fca5a5' }}>
            <li>• 카지노 게임에는 항상 금전적 손실 위험이 따릅니다.</li>
            <li>• <strong>만 18세 미만은 이용하실 수 없습니다.</strong></li>
            <li>• 도박은 수익 수단이 아닌 오락으로만 즐기시기 바랍니다.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            <a href="https://www.kcgp.or.kr" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-between p-5 rounded-xl transition group"
              style={{ background: '#111118', border: '1px solid rgba(201,168,76,0.2)' }}>
              <div>
                <p className="font-bold text-white text-sm group-hover:text-yellow-400 transition">한국도박문제관리센터</p>
                <p className="text-xs mt-1" style={{ color: '#8A8A9A' }}>전화상담 · 대면상담 · 온라인 상담 제공</p>
              </div>
              <div className="text-right shrink-0">
                <p className="font-bold text-lg" style={{ color: '#C9A84C' }}>1336</p>
            ...
            <div className="p-5 rounded-xl" style={{ background: '#111118', border: '1px solid rgba(201,168,76,0.1)' }}>
              ...
              <p className="font-bold" style={{ color: '#C9A84C' }}>1577-0199</p>
            </div>
          </div>
        </div>
